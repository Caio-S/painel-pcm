...
if (window.btnAloc) btnAloc.onclick = async () => { maskAloc.classList.add("on"); await alocRender() };
...
if (window.btnCont) btnCont.onclick = async () => { maskCont.classList.add("on"); await contatosRender() };
...
if (window.btnCls) btnCls.onclick = async () => { maskCls.classList.add("on"); await classRender() };
