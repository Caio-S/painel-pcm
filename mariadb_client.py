...
def fetch_os_abertas():
    ...
    Só entra O.S. de frota parada — usa codigo_situacao_veiculo (== descricao_situacao_veiculo,
    confirmado 1:1 no banco: P/Parada, R/Rodando, sem nenhum caso divergente) da PRÓPRIA
    O.S. aberta. Uma tentativa anterior trocou isso por "situação da O.S. mais recente da
    frota, aberta ou fechada" pra tentar pegar frotas que voltaram a rodar sem a O.S. ser
    fechada — mas isso quebrou o caso comum de O.S. administrativa rápida (aberta e fechada
    em minutos, ex.: documento 554304 da frota 62210) que fica marcada como "mais recente" e
    silenciosamente escondia O.S. de fato aberta e parada (ex.: documento 550568, mesma
    frota). Revertido: mais simples e mais correto na prática usar direto o campo da O.S.
